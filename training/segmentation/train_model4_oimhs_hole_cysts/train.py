...
TRAINING_ROOT = WORKSPACE_ROOT / "training" / "segmentation"
WEB_APP_ROOT = WORKSPACE_ROOT / "web-app"
if str(WORKSPACE_ROOT) not in sys.path:
    sys.path.insert(0, str(WORKSPACE_ROOT))
if str(TRAINING_ROOT) not in sys.path:
    sys.path.insert(0, str(TRAINING_ROOT))
if str(WEB_APP_ROOT) not in sys.path:
...
def train():
    ...
    version_base_dir = WORKSPACE_ROOT / "checkpoints" / "segmentation" / "model4_oimhs_hole_cysts"
