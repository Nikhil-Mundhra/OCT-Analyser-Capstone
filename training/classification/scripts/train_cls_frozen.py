...
sys.path.insert(0, str(WORKSPACE_ROOT / "web-app"))
sys.path.insert(0, str(WORKSPACE_ROOT / "training" / "classification"))
...
# Load Dataset module
cls_path = WORKSPACE_ROOT / "training" / "classification" / "data" / "dataset.py"
