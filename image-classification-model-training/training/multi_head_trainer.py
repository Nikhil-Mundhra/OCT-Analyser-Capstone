...
class MultiHeadTrainer:
    ...
    def _val_epoch(self, loader, smoke_test: bool = False):
        ...
        if len(h2_targets) > 0:
            ...
            h2_macro_f1, h2_acc = 0.0, 0.0
            
        return mean_loss, h2_macro_f1, h2_acc
    ...
    def train(
        ...
        for epoch in range(warmup_epochs):
            ...
            val_loss, h2_f1, h2_acc = self._val_epoch(val_loader, smoke_test=smoke_test)
            global_step += 1
            
            logger.info(f"Ep {epoch:3d} [warmup|fold{fold_id}] loss {train_loss:.4f}/{val_loss:.4f} | H2 F1 {h2_f1:.4f} | lr {warmup_lr:.2e}")
        ...
        for epoch in range(finetune_epochs):
            ...
            logger.info(f"Ep {abs_epoch:3d} [finetune|fold{fold_id}] loss {train_loss:.4f}/{val_loss:.4f} | H2 F1 {h2_f1:.4f} | lr {current_lr:.2e}")
