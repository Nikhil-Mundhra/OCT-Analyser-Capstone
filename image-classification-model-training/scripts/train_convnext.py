...
def main():
    ...
    parser.add_argument("--lr-head", type=float, default=3e-5, help="Learning rate for classification heads & CBAM attention blocks")
    parser.add_argument("--lr-backbone", type=float, default=2e-6, help="Learning rate for deep backbone stages (early stages receive 0.1x this rate)")
