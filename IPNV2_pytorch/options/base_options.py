...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='/scratch/yh3529/IPN_OCTA_Segmentation/Data/IEEE_IPN', help='path to data')
        ...
        parser.add_argument('--plane_perceptron', type=str, default='UNet_3Plus', help='UNet, UNet_3Plus')
        ...
        parser.add_argument('--saveroot', default='/scratch/yh3529/IPN_OCTA_Segmentation/IPNV2_pytorch/logs', help='path to save results')
