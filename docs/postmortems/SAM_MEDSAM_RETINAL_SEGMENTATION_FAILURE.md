...
![CSR Head-to-Head Comparison](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/CSR_Fluid_head_to_head_comparison.png)
...
![CSR Raw Red Mask Overlay](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/CSR_Fluid_raw_mask_overlay.png)
...
![ERM Head-to-Head Comparison](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/ERM_Membrane_head_to_head_comparison.png)
*Figure 2.1: ERM Head-to-Head. MedSAM 2 truncates lateral margins and fails to follow the tractional ILM curve.*

![ERM Raw Red Mask Overlay](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/ERM_Membrane_raw_mask_overlay.png)
...
![DME Cysts Head-to-Head Comparison](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/DME_Cysts_head_to_head_comparison.png)
...
![DME Raw Red Mask Overlay](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/DME_Cysts_raw_mask_overlay.png)
...
![NORMAL Head-to-Head Comparison](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/NORMAL_head_to_head_comparison.png)
*Figure 4.1: NORMAL Retina Head-to-Head. Comparison between stock SAM and MedSAM 2.*

![NORMAL Raw Red Mask Overlay](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/NORMAL_raw_mask_overlay.png)
...
![Chiu DME Dome Head-to-Head Comparison](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/Chiu_DME_Dome_head_to_head_comparison.png)
*Figure 5.1: Chiu DME Dome Head-to-Head Comparison.*

![Chiu DME Dome Raw Red Mask Overlay](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/Chiu_DME_Dome_raw_mask_overlay.png)
...
|---|---|---|
| ![CNV Comparison](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/CNV_Neovascularization_head_to_head_comparison.png) | ![MH Comparison](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/CHU_MH_MacularHole_head_to_head_comparison.png) | ![Drusen Comparison](../../archive/experiments/sam_and_medsam_retinal_segmentation_failure/images/DRUSEN_Deposits_head_to_head_comparison.png) |
